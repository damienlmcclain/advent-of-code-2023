...
class Test(TestCase):
    def test_input_parser(self):
        res = input_parser(filename='fixtures/day_01_part_1_easy_input.txt')
        expected_res = ['1abc2', 'pqr3stu8vwx', 'a1b2c3d4e5f', 'treb7uchet']
        self.assertEqual(res, expected_res)

        res = input_parser(filename='fixtures/day_01_part_2_easy_input.txt')
        expected_res = [
    ...
    def test_day_01_part_1_easy_input(self):
        res = find_calibration_value(
            part=1, filename='fixtures/day_01_part_1_easy_input.txt')
    ...
    def test_day_01_part_2_easy_input(self):
        res = find_calibration_value(
            part=2, filename='fixtures/day_01_part_2_easy_input.txt')
