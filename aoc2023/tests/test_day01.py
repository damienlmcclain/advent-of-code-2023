...
class Test(TestCase):
    def test_day_01_part_1_easy_input(self):
        res = part_one_find_ints(filename='fixtures/day_01_part_1_easy_input.txt')
    ...
    def test_day_01_part_2_easy_input(self):
        res = part_two_find_nums(filename='fixtures/day_01_part_2_easy_input.txt')
        expected_res = [[2, 1, 9], [8, 2, 3], [1, 2, 3], [2, 1, 3, 4], [4, 9, 8, 7, 2], [1, 8, 2, 3, 4], [7, 6]]
        self.assertEqual(res, expected_res)
